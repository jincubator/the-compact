...
library ClaimProcessorFunctionCastLib {
     ...
     */
    function usingClaim(function(bytes32, uint256, uint256, bytes32, bytes32, function(uint256, uint256, address, uint256) internal returns (bool)) internal returns (bool) fnIn)
        internal
        pure
        returns (function(bytes32, Claim calldata, uint256, bytes32, bytes32, function(uint256, uint256, address, uint256) internal returns (bool)) internal returns (bool) fnOut)
    {
     ...
     */
    function usingBatchClaim(function(bytes32, uint256, uint256, bytes32, bytes32, function(uint256, uint256, address, uint256) internal returns (bool)) internal returns (bool) fnIn)
        internal
        pure
        returns (function(bytes32, BatchClaim calldata, uint256, bytes32, bytes32, function(uint256, uint256, address, uint256) internal returns (bool)) internal returns (bool) fnOut)
    {
        assembly ("memory-safe") {
            fnOut := fnIn
        }
     ...
     */
    function usingMultichainClaim(function(bytes32, uint256, uint256, bytes32, bytes32, function(uint256, uint256, address, uint256) internal returns (bool)) internal returns (bool) fnIn)
        internal
        pure
        returns (function(bytes32, MultichainClaim calldata, uint256, bytes32, bytes32, function(uint256, uint256, address, uint256) internal returns (bool)) internal returns (bool) fnOut)
    {
        assembly ("memory-safe") {
            fnOut := fnIn
        }
     ...
     */
    function usingBatchMultichainClaim(function(bytes32, uint256, uint256, bytes32, bytes32, function(uint256, uint256, address, uint256) internal returns (bool)) internal returns (bool) fnIn)
        internal
        pure
        returns (function(bytes32, BatchMultichainClaim calldata, uint256, bytes32, bytes32, function(uint256, uint256, address, uint256) internal returns (bool)) internal returns (bool) fnOut)
    {
        assembly ("memory-safe") {
            fnOut := fnIn
        }
     ...
     */
    function usingExogenousMultichainClaim(function(bytes32, uint256, uint256, bytes32, bytes32, bytes32, function(uint256, uint256, address, uint256) internal returns (bool)) internal returns (bool) fnIn)
        internal
        pure
        returns (function(bytes32, ExogenousMultichainClaim calldata, uint256, bytes32, bytes32, bytes32, function(uint256, uint256, address, uint256) internal returns (bool)) internal returns (bool) fnOut)
    {
        assembly ("memory-safe") {
            fnOut := fnIn
        }
     ...
     */
    function usingExogenousBatchMultichainClaim(function(bytes32, uint256, uint256, bytes32, bytes32, bytes32, function(uint256, uint256, address, uint256) internal returns (bool)) internal returns (bool) fnIn)
        internal
        pure
        returns (
            function(bytes32, ExogenousBatchMultichainClaim calldata, uint256, bytes32, bytes32, bytes32, function(uint256, uint256, address, uint256) internal returns (bool)) internal returns (bool) fnOut
        )
    {
        assembly ("memory-safe") {
            fnOut := fnIn
