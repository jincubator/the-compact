...
// abi.decode(bytes("Lock[] commitments)Lock(bytes12 "), (bytes32))
bytes32 constant PERMIT2_ACTIVATION_BATCH_COMPACT_TYPESTRING_FRAGMENT_FOUR =
    0x4c6f636b5b5d20636f6d6d69746d656e7473294c6f636b286279746573313220;

// abi.decode(bytes("lockTag,address token,uint256 am"), (bytes32))
bytes32 constant PERMIT2_ACTIVATION_BATCH_COMPACT_TYPESTRING_FRAGMENT_FIVE =
    0x6c6f636b5461672c6164647265737320746f6b656e2c75696e7432353620616d;

// uint40(abi.decode(bytes("ount)"), (bytes5)))
uint40 constant PERMIT2_ACTIVATION_BATCH_COMPACT_TYPESTRING_FRAGMENT_SIX = 0x6f756e7429;

// abi.decode(bytes("Lock[] commitments,Mandate manda"), (bytes32))
bytes32 constant PERMIT2_ACTIVATION_BATCH_COMPACT_WITNESS_TYPESTRING_FRAGMENT_FOUR =
...
bytes32 constant PERMIT2_ACTIVATION_BATCH_COMPACT_WITNESS_TYPESTRING_FRAGMENT_FIVE =
...
uint232 constant PERMIT2_ACTIVATION_BATCH_COMPACT_WITNESS_TYPESTRING_FRAGMENT_SIX =
